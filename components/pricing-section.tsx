...
const plans = [
  {
    ...
    price: "$0",
    period: "forever",
    description: "Try ITSquare with your team",
    features: [
  ...
  },
  {
    ...
    description: "Proactive IT support with health scoring",
    features: [
      "Unlimited AI conversations",
      "DEX health scoring per device",
  ...
  },
  {
    ...
    price: "$18",
    period: "per user/month",
    description: "Fleet management with governance built in",
    features: [
      "Everything in Pro",
      "Fleet health dashboard",
      "AI governance audit trails",
      "Auto-remediation reports",
