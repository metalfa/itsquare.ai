...
// Bot scopes — must match exactly what is configured in api.slack.com/apps OAuth & Permissions.
// Roadmap scopes (assistant:write, bookmarks:*, calls:*, incoming-webhook) must be added
// in the Slack app config dashboard BEFORE being requested here.
...
// User scopes — only requested during sign-up/sign-in flow.
// Admin/Enterprise scopes require special Slack approval — add only after granted.
