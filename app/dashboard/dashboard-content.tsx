                ...
                <CardContent>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link href="/dashboard/integrations" className="flex-1">
                      <Button 
                        className="bg-primary-container hover:bg-primary-container/90 text-white font-medium w-full"
                      >
                    ...
                    <Link href="/dashboard/integrations" className="flex-1">
                      <Button 
                        variant="outline"
                        className="border-outline-variant/30 w-full"
                      >
                  ...
                  <p className="text-xs text-muted-foreground mt-4">
                    We use read-only access to analyze your identity data securely.
                  </p>
                </CardContent>
              </Card>
            )}
